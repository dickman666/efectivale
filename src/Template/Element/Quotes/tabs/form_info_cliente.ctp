...
<h6 class="instructions">Busque el nombre del cliente en caso de que ya se encuentre registrado</h6>
<div class="row" style="margin:20px -15px 40px -15px;">
    <div class="col-xs-6">
...
<div class="input-cliente" style="margin-bottom:100px;">
    <h5><?= __('GENERAL') ?></h5>
    <h6 class="instructions">Para agregar un nuevo cliente ingrese los datos en esta sección.</h6>
    <hr>
...
<script type="text/javascript">
    ...
    function disabledInputs(value, empty) {
        ...
        $('.input-cliente .input-contacto input').prop('disabled', false);
        $('.input-cliente .input-contacto select').prop('disabled', false);
    }
