...
class QuoteProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'quote_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'amount' => 1,
            'price' => 1.5,
            'modified' => '2018-04-06 18:51:45',
            'created' => '2018-04-06 18:51:45'
        ],
    ];
}
