...
/**
 * InventarioTipoActualizacionFixture
 *
 */
class InventarioTipoActualizacionFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'inventario_tipo_actualizacion';
    ...
    public $records = [
        [
            ...
            'created_at' => 1577805802,
            'updated_at' => 1577805802
        ],
    ];
}
