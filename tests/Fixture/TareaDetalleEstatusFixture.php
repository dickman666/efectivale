...
/**
 * TareaDetalleEstatusFixture
 *
 */
class TareaDetalleEstatusFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'tarea_detalle_estatus';
    ...
    public $records = [
        [
            ...
            'created_at' => 1577815931,
            'updated_at' => 1577815931
        ],
    ];
}
