...
/*
        ...
        public function beforeFilter(Event $event) {
                ...
                $this->Auth->allow(['login', 'logout', 'register', 'userVerification', 'forgotPassword', 'activatePassword', 'accessDenied', 'emailVerification', 
                                    'addUserWS'/*FU-4*/, 'editUserWS'/*FU-7*/, 'changeUserPasswordWS'/*FU-5*/]);
                ...
                if(isset($this->Csrf) && ($this->request['action'] == 'addUserWS' || $this->request['action'] == 'editUserWS' || $this->request['action'] == 'changeUserPasswordWS')) { // FU-4, FU-7, FU-5
        ...
        public function index() {
            ...
            $conditions[] = ['Users.deleted' => FALSE];
            ...
            $this->set(compact('users', 'userEntity', 'userGroups', 'options', 'page'));
        ...
        public function addUser() {
            if (!$this->UserAuth->isSuper()) {
                ...
                $userEntity['password'] = $this->UserAuth->generatePassword();
                ...
                if($this->request->is('post')) {
                        ...
                        if($this->request->is('ajax')) {
                                if(empty($errors)) {
                                        $response = ['error'=>0, 'message'=>'success', 'entity'=>$userEntity];
                                } else {
                                        $response = ['error'=>1, 'message'=>'failure', 'entity'=>$userEntity];
                                ...
                                if(empty($errors)) {
                                        ...
                                        if($this->Users->save($userEntity, ['validate'=>false])) {
                                                if(!isset($userEntity['user_detail']['id'])) {
                                                        ...
                                                        $this->Users->sendWelcome($userEntity);
    
                                                }
                                                $this->Flash->success(__('The user has been added successfully'));
                                                $this->redirect('/usermgmt/users');
                                        } else {
                ...
                $this->loadModel('Usermgmt.UserGroups');
                $userGroups = $this->UserGroups->getUserGroups(true);

                $genders = [['value'=>'M', 'text'=>'Masculino'], ['value'=>'F', 'text'=>'Femenino']];
                        ...
                        if(!empty($user)) {
                                if($this->request->is('post')) {
                                        if($this->Users->save($user)) {
                                                ...
                                                $this->Flash->success(__('El usuario se archivo'));
                                        } else {
                                                $this->Flash->error(__('El usuario no se pudo archivar. Intentalo de nuevo'));
                                        }
                                }
                        } else {
                                $this->Flash->error(__('Invalid User Id'));
                ...
                if(!empty($userId)) {
                        ...
                        if(!empty($user)) {
                                if($this->request->is('post')) {
                                        ...
                                        $userEntity['active'] = 1;
                                        $userEntity['user_status_id'] = 1;
                                        $this->Users->save($userEntity, ['validate'=>false]);
                                        $this->Users->NotificacionUsuario($user);
                                        $this->loadModel('Usermgmt.UserActivities');
        ...
        public function uploadCsv() {
                ...
                $this->set(compact('userGroups', 'genders', 'page'));
        }
        /**
                        ...
                        if($this->request->is('post')) {
                                ...
                                if($this->request->is('ajax')) {
                                        ...
                                        if(empty($errors) && $loginValid) {
                                                ...
                                                if( $user['terms_and_conditions'] == TRUE || isset( $this->request->data['Users']['terms_and_conditions'] ) &&  $this->request->data['Users']['terms_and_conditions'] == '1'){

                                                        if( isset( $this->request->data['Users']['terms_and_conditions'] ) || $user['active'] == 1){
                                                                $userEntity = $this->Users->getUserById( $user['id'] );
                                                                $userEntity->terms_and_conditions = TRUE;
                                                                $userEntity->user_status_id = 1;
                                                        ...
                                                        $this->Flash->error('Acepta Términos y Condiciones');
                                                }
                        ...
                        if($this->request->is('post')) {
                                ...
                                if($this->request->is('ajax')) {
                                        ...
                                        if(empty($errors)) {
                                                ...
                                                $userEntity['active'] = 0;
                                                $userEntity['terms_and_conditions'] = 1;
                                                $userEntity['user_status_id'] = 2;
                                                $userEntity['ip_address'] = $this->request->clientIp();
                                                $userEntity['password'] = $this->UserAuth->makeHashedPassword($userEntity['password']);
                                                ...
                                                if($this->Users->save($userEntity, ['validate'=>false])) {
                                                        ...
                                                        if(isset($userEntity['active']) && $userEntity['active'] && !EMAIL_VERIFICATION) {
                                                                ...
                                                                $this->Flash->success(__('Registro realizado correctamente, espera notificación de activación de cuenta.'));
            ...
            //else {
                ...
                if(!empty($userId)) {
                        ...
                        if(!empty($userEntity)) {
                                        ...
                                        if($this->request->is('ajax')) {
                                                ...
                                                if(empty($errors)) {
                                                        if(!empty($this->request->data['Users']['photo_file']['tmp_name']) && is_uploaded_file($this->request->data['Users']['photo_file']['tmp_name']))
                                                        {
                                                                ...
                                                                $existing_photo = $userEntity['photo'];
                                                                $userEntity['photo'] = $photo;
                                                                $this->request->session()->write('Auth.User.photo',$photo);
                                                                if(!empty($existing_photo) && file_exists($fullpath.DS.$existing_photo)) {
                                                                        unlink($fullpath.DS.$existing_photo);
                                                                }
                                                        }
                                ...
                                $page = "Edit Profile";
                                $days = $this->Users->getDays();
                                $months = $this->Users->getMonth();
                                $genders = [['value'=>'M', 'text'=>'Masculino'], ['value'=>'F', 'text'=>'Femenino']];
                                $this->set(compact('userEntity', 'genders', 'page', 'days', 'months'));
                        } else {
                                $this->Flash->error(__('Invalid User Id'));
                                $this->redirect(['action'=>'myprofile']);
                        }
        ...
        public function changePassword() {
            ...
            //else {
                ...
                if($userId) {
                        ...
                        $this->set(compact('userEntity', 'page'));
                } else {
                        $this->Flash->error(__('Invalid User Id'));
                        $this->redirect(['action'=>'dashboard']);
                }
        ...
        public function sendEmail($userId = null){

                $entity =  $this->Users->get($userId);

                if( isset( $entity['email'] ) && !empty( $entity['email'] ) ){
                        if( $entity['email_verified'] == 1 ){
                                $this->Users->sendWelcome($entity);
                                $this->Flash->success(__('La invitación se envío correctamente.'));
                        }else{
                                $this->Flash->info(__('El registro aún no ha sido confirmado.'));
                        }
                }else{
                        $this->Flash->error(__('Este usuario no tiene correo electrónico.'));
                }
         ...
         * @return void
         */
        public function addUserWS() { // FU-4
            $this->loadModel('Usermgmt.UserDetails');

            $userEntity = $this->Users->newEntity($this->request->query, ['validate'=>'forAddUserWS', 'associated'=>['UserDetails'=>['validate'=>'forAddUser']]]);
            $response = ['error'=>false, 'message'=>'success', 'entity'=>$this->request->query];
            if ($this->request->is('post')) 
            {
                $errors = $userEntity->errors();
                if (empty($errors)) 
                {
                    ...
                    elseif ($userEntity['gender'] == '2') {
                        $userEntity['gender'] = 'M';
                    }
                    if ($userEntity['active'] == '2') {
                        $userEntity['active'] = '0';
                    }
                    
                    if (strlen($this->request->query['created']) == 10) {
                        $userEntity->created = new Time(substr($this->request->query['created'], 0, 4).'-'.
                                            substr($this->request->query['created'], 5, 2).'-'.
                                            substr($this->request->query['created'], 8, 2));
                    }
                    elseif (strlen($this->request->query['created']) == 8) {
                        $userEntity->created = new Time(substr($this->request->query['created'], 0, 4).'-'.
                                            substr($this->request->query['created'], 4, 2).'-'.
                                            substr($this->request->query['created'], 6, 2));
                    }
                    else {
                        $userEntity->created = Time::now();
                    }
                    
                    if (strlen($this->request->query['modified']) == 10) {
                        $userEntity->modified = new Time(substr($this->request->query['modified'], 0, 4).'-'.
                                            substr($this->request->query['modified'], 5, 2).'-'.
                                            substr($this->request->query['modified'], 8, 2));
                    }
                    elseif (strlen($this->request->query['modified']) == 8) {
                        $userEntity->modified = new Time(substr($this->request->query['modified'], 0, 4).'-'.
                                            substr($this->request->query['modified'], 4, 2).'-'.
                                            substr($this->request->query['modified'], 6, 2));
                    }
                    else {
                        $userEntity->modified = null;
                    }
                    ...
                    if ($this->Users->save($userEntity, ['validate'=>false])) {
                        ...
                        $response = ['error'=>true, 'message'=>__('Unable to save user, please try again'), 'entity'=>$this->request->query];
                    }
                }
                else
                {
                    $aErrors = [];
                    foreach ($errors as $oError) {
                        array_push($aErrors, implode('', array_values($oError)));
                    }
                    $response = ['error'=>true, 'message'=>implode('. ', $aErrors), 'entity'=>$this->request->query];
                }
            }
            else
            {
                $response = ['error'=>true, 'message'=>'Método inválido', 'entity'=>$this->request->query];
            }
         ...
         * @return void
         */
        public function editUserWS() { // FU-7
            $this->loadModel('Usermgmt.UserDetails');

            $username = (isset($this->request->query['username'])) ? $this->request->query['username'] : '';
            if ($username == '') {
                $response = ['error'=>true, 'message'=>__('Please enter username'), 'entity'=>$this->request->query];
            }
            else 
            {
                $userEntity = $this->Users->findByUsernameOrEmail($username, $username)->first();
                if(empty($userEntity)) 
                {
                    $response = ['error'=>true, 'message'=>__('Incorrect Username'), 'entity'=>$this->request->query];
                }
                else
                {
                    $this->Users->patchEntity($userEntity, $this->request->query, ['validate'=>'forEditUser', 'associated'=>['UserDetails'=>['validate'=>'forEditUser']]]);
                    $response = ['error'=>false, 'message'=>'success', 'entity'=>$this->request->query];
                    if ($this->request->is('post')) 
                    {
                        $errors = $userEntity->errors();
                        if (empty($errors)) 
                        {
                            ...
                            elseif (strlen($this->request->query['modified']) == 8) {
                                ...
                                $userEntity->modified = new Time($userEntity->modified);
                            }
        ...
        /**
         * It is used to change user password in a WebService
         *
         * @access public
         * @return void
         */
        public function changeUserPasswordWS() { // FU-5
            $this->loadModel('Usermgmt.UserDetails');
            ...
            else 
            {
                ...
                {
                    $query = [];
                    $query['password'] = $this->request->query['password'];
                    $this->Users->patchEntity($userEntity, $query, ['validate'=>'forChangePasswordWS', 'associated'=>['UserDetails'=>['validate'=>'forEditUser']]]);
                    $response = ['error'=>false, 'message'=>'success', 'entity'=>$this->request->query];
                    if ($this->request->is('post')) 
                    {
                        $errors = $userEntity->errors();
