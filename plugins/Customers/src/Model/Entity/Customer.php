...
class Customer extends Entity
{
    ...
    public function _getCustomerFranchisesDisplayList(){
        return Hash::combine($this->customer_franchises ? $this->customer_franchises : [], '{n}.franquicia_id', '{n}.franquicia.title');
    }

    public function _getCustomerFranchisesList(){
        return Hash::combine($this->customer_franchises ? $this->customer_franchises : [], '{n}.id', '{n}.franquicia_id');
    }
