...
<div class="ibox" id="customers-view">
    ...
    <div class="ibox-content no-padding">
        ...
        <div class="col-lg-12 clearfix">
            <div class="col-lg-10 right-bordered top-bordered" style="min-height: 500px;">
                <div class="row">
                    ...
                    <div class="col-lg-12 no-padding">
                        ...
                        <ul id="controlTabs" class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#franq"  id="franq-tab" role="tab" data-toggle="tab" aria-controls="franq" aria-expanded="true">
                                    <?= __("Franquiciatarios") ?>
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#ot"  id="ot-tab" role="tab" data-toggle="tab" aria-controls="ot" aria-expanded="true">
                                    <?= __("Órdenes de Trabajo") ?>
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#ubicaciones"  id="ubicaciones-tab" role="tab" data-toggle="tab" aria-controls="ubicaciones" aria-expanded="true">
                                    <?= __("Ubicaciones") ?>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade in" id="franq" aria-labelledBy="franq-tab">
                                <?= $this->element('Customers/franquisitarios'); ?>
                            </div>
                            <div role="tabpanel" class="tab-pane fade in" id="ot" aria-labelledBy="ot-tab">
                                <?= $this->element('Customers/ordenesDeTrabajo'); ?>
                            </div>
                            <div role="tabpanel" class="tab-pane fade in" id="ubicaciones" aria-labelledBy="ubicaciones-tab">

                                <h1 class="page-title"><?= __('Ubicaciones') ?></h1>
                                <div class="portlet light bordered ">
                                    <div class="portlet-title">
                                        <div class="actions">
                                            ...
                                            <div class="col-lg-3">
                                                <a href="/ubicaciones/save/<?= $customer->id ?>" class="medium-font ca-add" style="width: 30px;height: 30px;display: inline-block;position: relative;top: 10px;margin-left: 15px;" data-remote="false" data-toggle="modal" data-target="#genericModal">
                                    </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <?= $this->element('Ubicaciones/ubicaciones', ['items' => $customer->ubicaciones]); ?>
            ...
            <div class="col-lg-2 top-bordered">
...
<script type="text/javascript">
    $('#ot-tab').on('shown.bs.tab', function (e) {
