    ...
    <table id="customersTable" class="table table-striped table-bordered table-hover dt-responsive dataTable no-footer dtr-inline w-AvenirLight collapsed">
        <thead>
            <tr>
              ...
              <th style="min-width:  90px" scope="col" class="sorting-link"><?= $this->Paginator->sort('rfc', __('RFC')) ?></th>
              <th style="min-width:  90px" scope="col" class="sorting-link"><?= $this->Paginator->sort('municipality', __('Municipality')) ?></th>
              <th style="min-width:  80px" scope="col" class="sorting-link"><?= $this->Paginator->sort('state', __('State')) ?></th>
              <th style="min-width:  80px" scope="col" class="sorting-link"><?= $this->Paginator->sort('country', __('Country')) ?></th>
              <th style="min-width:  90px" scope="col" class="sorting-link"><?= $this->Paginator->sort('postal_code', __('Postal Code')) ?></th>
              <th style="min-width:  80px" scope="col" class="sorting-link"><?= $this->Paginator->sort('customer_status_id', __('Estatus')) ?></th>
              <th scope="col" class="sorting-link"><?= $this->Paginator->sort('customer_category_id', __('Customer Category')) ?></th>
              <th scope="col" class="sorting-link"><?= $this->Paginator->sort('name_office', __('Sucursal')) ?></th>
              <th scope="col" class="sorting-link"><?= $this->Paginator->sort('phone', __('Teléfono')) ?></th>
                  ...
                  <td class="actions">
                    <div class='btn-group'>
                        ...
                        <ul class='dropdown-menu pull-right'>
                            <li>
                                <a
                                    href="/customers/customers/select-franchise/<?= $customer->id ?>"
                                    data-remote="false"
                                    data-toggle="modal"
